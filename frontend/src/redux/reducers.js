...
const user = (state = { isLoggedIn: false, isLoggingIn: false, name: '', email: '', token: '', isRegistering: false, hasRegistered: false }, action) => {
  switch (action.type) {
    ...
    case REGISTER_POST:
      return Object.assign({}, { isLoggingIn: false, isLoggedIn: false, name: '', token: '', isRegistering: true });
    case REGISTER_SUCCESS:
      return Object.assign({}, { isLoggingIn: false, isLoggedIn: false, name: '', token: '', isRegistering: false, hasRegistered: true });
    case REGISTER_FAILURE:
      return Object.assign({}, { isLoggingIn: false, isLoggedIn: false, name: '', token: '', isRegistering: false, hasRegistered: false });
    default:
      return state;
  }
}
